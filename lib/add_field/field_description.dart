  ...
  final List<Map<String, dynamic>> detailLapangan = [
    {
      ...
      'harga': 'Rp. 60.000-80.000/jam',
      'gambar': 'images/lapangan.png',
      'description': 'Lapangan Golden adalah lapangan Futsal dan Badminton yang memiliki 6 lapangan di kota Semarang.',
      'rule': 'Jangan nakal',
      'fasilitas': ['Toilet', 'WiFi', 'Parkir Mobil', 'Parkir Motor', 'Mushola'],
    },
    {
      'nama': 'Sapphire',
      'rating': '0 Rating',
      ...
      'gambar': 'images/basketball.jpg',
      'description': 'Lapangan Sapphire adalah lapangan Futsal dan Badminton yang memiliki 6 lapangan di kota Semarang.',
      'rule': 'Jangan nakal',
      ...
      body: Padding(
        ...
        child: Stack(
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(top: 385, left: 12, right: 12, bottom: 10),
              child: Divider(
                thickness: 0.5,
                height: 0.2,
              ),
