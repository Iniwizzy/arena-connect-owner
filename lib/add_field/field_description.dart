...
// void main () {
//   runApp(MaterialApp(home: FieldDescription()));
// }
...
//         'lokasi': 'Jl. Mulawarman Sel. Dalam I, Kramas, Kec. Tembalang, Kota Semarang',
...
//       //   'lokasi': 'Kota Bandung',
//       //   'harga': 'Rp. 70.000-90.000/jam',
//       //   'gambar': 'images/basketball.jpg',
//       // },
//       // {
//       //   'nama': 'Gondang',
//       //   'rating': '0 Rating',
//       //   'lapang': ['Futsal', 'Volley'],
//       //   'lokasi': 'Kota  Surabaya',
//       //   'harga': 'Rp. 70.000-100.000/jam',
//       //   'gambar': 'images/volley.jpg',
//       // },
//     ];
...
//           children: [
//             ClipRRect(
//               borderRadius: const BorderRadius.only(bottomRight: Radius.elliptical(300, 30), bottomLeft: Radius.elliptical(300, 30)),
//               child: Image.asset(
//                 height: 250,
...
//                       ],
//                     ),
//                     Text('0 Rating', style: regulerfont3,)
//                   ],
//                 ),
//               ),
//             ),
...
import 'package:arena_connect/add_field/child_field.dart';
import 'package:arena_connect/add_field/select_hour.dart';
...
class FieldDescription extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: Stack(
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                          lapangan['gor'], // Menampilkan nama dari data
                          style: lampiran3Style.copyWith(fontSize: 14),
                        ),
                    const SizedBox(height: 10),
                    Row(
                      children: lapangan['lapang'].map<Widget>((lapang) => Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(lapang, style:facilityStle, textAlign: TextAlign.center),
                          ],
                        ),
                      )).toList(),
                    ),
                    ...
                    //     // ),
                    //     IconButton(
                    //       icon: const Icon(Icons.location_on, color: Colors.grey, size: 18,),
                    //       style: IconButton.styleFrom(
                    //         padding: const EdgeInsets.all(0),
                    //         minimumSize: const Size(30, 30),
                    //       ),
                    //       onPressed: () {}, // Untuk menampilkan lokasi di google maps
                    //     ),
                    //   ],
                    // ),
                    // const SizedBox(height: 6),
                    const SizedBox(height: 12),
                    Text('mulai ', style: lampiran2Style),
                    Text(
                    ...
                    Center(
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => JamSewaPage()));
                        },
                        style: shortButton3,
                        child: Text('Atur Jam Sewa', style: buttonTextStyle, textAlign: TextAlign.center),
                      ),
                    ),
                    // TextButton(
                    //   onPressed: () {
                    ...
                    //   ),// Untuk menampilkan detail lapangan
                    //   child: const Text(
                    //   'Selengkapnya...',
                    //   style: TextStyle(color: Colors.black, fontSize: 9, fontFamily: 'Poppins', fontWeight: FontWeight.w500),
                    //   ),
                    // ),
                  ],
                ),
            ...
            const Padding(
              padding: EdgeInsets.only(top: 400, left: 12, right: 12, bottom: 10),
              child: Divider(
                thickness: 0.5,
                height: 0.2,
              ),
            ...
            // Padding(
            //   padding: const EdgeInsets.only(top: 395, left: 12, right: 12, bottom: 10),
            //   child: Column(
            //     children: [
            //       Row(
            //         mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            //       GestureDetector(
            //         onTap: () {Navigator.push(context , MaterialPageRoute(builder: (context) => ChildField()));},
            //         child: SizedBox(
            //           height: 30,
            //           child: Row(
            //             mainAxisAlignment: MainAxisAlignment.start,
  ...
  //           Wrap(
  //             spacing: 8,
  //             children: lapangan['fasilitas'].map<Widget> ((fasilitas) => Container(
  ...
  //                     const SizedBox(width: 18),
  //                   ],
  //                   Text(fasilitas, style:facilityStle, textAlign: TextAlign.center),
  //                 ],
  //               ),
  //             )).toList(),
  //           ),
