...
TextStyle decTextStyle = GoogleFonts.poppins(
  color: whitecolor,
  fontWeight: FontWeight.w300,
  fontSize: 12,
);
...
TextStyle notifikasiStyle = GoogleFonts.poppins(
  color: const Color(0xffffffff),
  fontWeight: FontWeight.w500,
  fontSize: 20,
);

TextStyle lampiranStyle = GoogleFonts.poppins(
  color: Colors.black,
  fontWeight: FontWeight.w600,
  fontSize: 14,
);

TextStyle dec2TextStyle = GoogleFonts.poppins(
  color: Colors.black,
  fontWeight: FontWeight.w400,
  fontSize: 11,
);
TextStyle dec3TextStyle = GoogleFonts.poppins(
  color: Colors.white,
  fontWeight: FontWeight.w300,
  fontSize: 11,
);
