...
class _RegisterFieldState extends State<RegisterField> {
  ...
  if (_selectedImages.length < 5) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Anda hanya dapat mengupload maksimal 5 gambar.')),
    );
  }
}
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildInputField(labelText: "Lokasi", controller: _locationController),
                  const SizedBox(height: 24),
                  buildInputField(labelText: "Deskripsi", maxLines: 4, controller: _descriptionController),
                  const SizedBox(height: 24),
                  buildInputField(labelText: "Aturan lapangan", maxLines: 4, controller: _rulesController),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: isFormFilled() ? primary : Colors.grey.shade400,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10),
                      ),
                    ),
                    onPressed: isFormFilled() ? () {
                      Navigator.pushNamed(context, '/menambahlapangan');
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Selanjutnya',
                          style: superFont2.copyWith(color: Colors.white, fontWeight: FontWeight.w500),
                        ),
